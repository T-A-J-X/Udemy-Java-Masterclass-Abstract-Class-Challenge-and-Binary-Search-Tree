...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //Create a string data array to avoid typing loads of addItem instructions
        String stringData = "Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
        String[] data = stringData.split(" ");//String split method which splits the String above at each space, creating an array of those Strings which we can put in the loop below
        for(String s : data) {
            list.addItem(new Node(s));//MyLinkedList object.add new Node object of type String from s
        }
